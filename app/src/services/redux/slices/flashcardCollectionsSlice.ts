...
export const flashcardCollectionsSlice = createSlice({
	...
	initialState,
	reducers: {
		setFlashcardCollection: (state, action: PayloadAction<FlashcardCollectionModel[]>) => {
...
export const { setFlashcardCollection, createFlashcardCollection, removeFlashcardCollection, addFlashcardToCollection, editFlascardCollection } = flashcardCollectionsSlice.actions;
